...
public class User {
	 ...
	 * 
	 * @param response
	 *            is the json response from server.
	 * @throws JSONException
	 *             is thrown when there is error while parsing response.
	...
	/**
	 * Parses array details of product, exchange and order_type from json
	 * response.
	 * 
	 * @param response
	 *            is the json response from server.
	 * @param user
	 *            is the object to which data is copied to from json response.
