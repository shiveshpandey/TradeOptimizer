...
/**
 * Ticker provider sends tokens to com.zerodhatech.com.zerodhatech.ticker server
 * and get ticks from com.zerodhatech.com.zerodhatech.ticker server. Ticker
 * server sends data in bytes. This Class gets ticks and converts into readable
 * format which includes our own business logic.
 */
public class KiteTicker {
	...
	public static String modeFull = "full", // Full quote inludes Quote items,
											// market depth, OI, day high OI,
											// day low OI, last traded time,
											// tick timestamp.
			modeQuote = "quote", // Quote includes last traded price, last
									// traded quantity, average traded price,
									// volume, total bid(buy quantity), total
									// ask(sell quantity), open, high, low,
									// close.
	 ...
	 * 
	 * @param accessToken
	 *            is the token received after successful login process.
	 * @param apiKey
	 *            is the api key of the app which is received after creating an
	 *            app on developers console.
	 */
	 ...
	 * 
	 * @return TimerTask returns timer task which will be invoked after user
	 *         defined interval and tries reconnect.
	 */
	...
	/**
	 * Set tryReconnection, to instruct KiteTicker that it has to reconnect, if
	 * com.zerodhatech.ticker is disconnected.
	 * 
	 * @param retry
	 *            will denote whether reconnection should be tried or not.
	 */
	 ...
	 * 
	 * @param listener
	 *            of type OnError which listens to all the type of errors that
	 *            may arise in Kite Ticker class.
	 */
	...
	/**
	 * Set max number of retries for reconnection, for infinite retries set
	 * value as -1.
	 * 
	 * @param maxRetries
	 *            denotes maximum number of retries that the
	 *            com.zerodhatech.ticker can perform.
	 * @throws KiteException
	 *             when maximum retries is less than 0.
	 */
	 ...
	 * 
	 * @param listener
	 *            is used to listen to order updates.
	 */
