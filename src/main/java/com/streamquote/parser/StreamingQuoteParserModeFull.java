...
public class StreamingQuoteParserModeFull implements IStreamingQuoteParser {
	...
	public StreamingQuote parse(ByteBuffer pktBuffer, String time) {
		...
		// Bid
		MarketDepth bidEntry1 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth bidEntry2 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth bidEntry3 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth bidEntry4 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth bidEntry5 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());

		// Offer
		MarketDepth offerEntry1 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth offerEntry2 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth offerEntry3 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth offerEntry4 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());
		MarketDepth offerEntry5 = new MarketDepth(
				convertIntToLong(pktBuffer.getInt()),
				convertIntToBigDecimal(pktBuffer.getInt()), pktBuffer.getInt());

		StreamingQuote streamingQuote = new StreamingQuoteModeFull(time,
				...
				convertIntToBigDecimal(closePrice), bidEntry1, bidEntry2,
				bidEntry3, bidEntry4, bidEntry5, offerEntry1, offerEntry2,
				offerEntry3, offerEntry4, offerEntry5);
