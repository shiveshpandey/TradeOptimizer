...
public class WebsocketThread implements Runnable, WebServiceSessionNotifier {
	...
	/**
	 * sendSubscribeMessage - private method to send subscribe message for the
	 * instruments
	 */
	...
	/**
	 * sendUnSubscribeMessage - private method to send unsubscribe message for
	 * the instruments
	 */
	...
	/**
	 * getInstrumentString - private method to create instrument string from
	 * instrument list
	 * 
	 * @param instrumentList
	...
	/**
	 * reInitiateOnWSOpenFailure - private method to reinitiate websocket
	 * session on Open Failure
	 */
	...
	/**
	 * fireDataMissTimerOnWSsubscribe - private method to fire data miss timer
	 * on subscribe
	 */
