...
public class Routes {
	...
	/*
	 * 
	 * "parameters": "/parameters", "api.validate": "/session/token",
	 * "api.invalidate": "/session/token", "user.margins":
	 * "/user/margins/{segment}",
	 * 
	 * "orders": "/orders", "trades": "/trades", "orders.info":
	 * "/orders/{order_id}",
	 * 
	 * "orders.place": "/orders/{variety}", "orders.modify":
	 * "/orders/{variety}/{order_id}", "orders.cancel":
	 * "/orders/{variety}/{order_id}", "orders.trades":
	 * "/orders/{order_id}/trades",
	 * 
	 * "portfolio.positions": "/portfolio/positions", "portfolio.holdings":
	 * "/portfolio/holdings", "portfolio.positions.modify":
	 * "/portfolio/positions",
	 * 
	 * "market.instruments.all": "/instruments", "market.instruments":
	 * "/instruments/{exchange}", "market.quote":
	 * "/instruments/{exchange}/{tradingsymbol}", "market.historical":
