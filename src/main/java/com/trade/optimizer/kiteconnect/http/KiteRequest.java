...
import com.trade.optimizer.exceptions.KiteClientNetworkException;
import com.trade.optimizer.exceptions.KiteDataException;
import com.trade.optimizer.exceptions.KiteException;
import com.trade.optimizer.exceptions.KiteGeneralException;
import com.trade.optimizer.exceptions.KiteInputException;
import com.trade.optimizer.exceptions.KiteNetworkException;
import com.trade.optimizer.exceptions.KiteNoNetworkException;
import com.trade.optimizer.exceptions.KiteOrderException;
...
public class KiteRequest {
    ...
    public JSONObject getRequest(String url, Map<String, Object> params)
            throws KiteException, JSONException {
     ...
     * PUT request.
     */
    public JSONObject putRequest(String url, Map<String, Object> params)
            throws KiteException, JSONException {
     ...
     * DELETE request.
     */
    public JSONObject deleteRequest(String url, Map<String, Object> params)
            throws KiteException, JSONException {
     ...
     */
    public KiteException dealWithKiteException(JsonNode jsonObject, int errorCode)
