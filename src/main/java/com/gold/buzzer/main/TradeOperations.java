...
public class TradeOperations {
	...
	public void getTriggerRange(KiteConnect kiteConnect) throws KiteException, IOException {
		...
		// trigger range.
		TriggerRange triggerRange = kiteConnect.getTriggerRange(Constants.EXCHANGE_CDS, "USDINR18JANFUT",
	 ...
	 * @return
	 */
	public List<Instrument> getInstrumentsForExchange(KiteConnect kiteConnect, String exchange)
			throws KiteException, IOException {
		// Get instruments for an exchange.
		List<Instrument> nseInstruments = kiteConnect.getInstruments(exchange);
